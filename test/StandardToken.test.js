...
contract('StandardToken', function ([deployer, owner, recipient, anotherAccount]) {
  ...
  describe('transfer', function () {
    ...
    describe('when the recipient is the zero address', function () {
      ...
      it('reverts', async function () {
        await assertRevert(this.token.transfer(to, INITIAL_SUPPLY, { from: owner }));
      });
    });
  });
  ...
  describe('transfer from', function () {
    ...
    describe('when the recipient is not the zero address', function () {
      ...
      describe('when the spender has enough approved balance', function () {
        beforeEach(async function () {
          await this.token.approve(spender, INITIAL_SUPPLY, { from: owner });
        });
        ...
        describe('when the owner does not have enough balance', function () {
          const amount = INITIAL_SUPPLY*2;

          it('reverts', async function () {
            var bal = await web3.eth.getBalance(spender)
